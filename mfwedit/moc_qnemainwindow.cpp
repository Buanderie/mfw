...
**
** Created: Thu Dec 11 15:09:31 2014
...
static const char qt_meta_stringdata_QNEMainWindow[] = {
    "QNEMainWindow\0\0saveFile()\0loadFile()\0"
    "addBlock()\0"
};
...
const QMetaObjectExtraData QNEMainWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QNEMainWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QNEMainWindow,
      qt_meta_data_QNEMainWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QNEMainWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNEMainWindow))
